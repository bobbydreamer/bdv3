...
1. There are many solutions to this like [.htaccess](https://www.youtube.com/watch?v=-6LyG9I-FPc), but to me better one is running the application in a server like NodeJS. 
