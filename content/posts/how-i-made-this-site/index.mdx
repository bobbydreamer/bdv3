---
title: How i made this gatsby site
date: 2020-03-15
...
This process is going to be same as how every software application is made ,there is nothing different. First there was a plan and it was very simple "Make a new site" and then requirements starts pouring in and eventually, i said to myself, it needs to stop and then made a choice and went on with it. 

This is the thing, **THE SDLC**

| N  | Stages                                   | Activity |
| -- | ---------------------------------------- | ---- |
| 1  | [Plan](/things-that-my-new-site-should-have) | I want to build a new site. So started collecting all the things, i want in this new site. There is no stopping me here |
| 2  | [Define](/epiphany-moment)  | Epiphany Moment. Its going to be a plain content site, nothing else. <-- thats not a dot, its a full stop to everything except content |
| 3  | Design | Well you are here. Next 3 stages are repetitive |
