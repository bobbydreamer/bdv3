...
1. Observe cravings and where they are coming from. Don't try to control it. Just be conscious of it. 
    - *The secret to self control | Jonathan Bricker | TEDxRainier*

2. If we can control the sources that control us, we are more likely to control our behaviour. 
    - *Change anything! Use skillpower over willpower | Al Switzler | TEDxFremont*

3. Difference between friends and accomplices, friends are who can help you, accomplices are friends who can help you, get into trouble. Sometimes it's hard to tell the difference. 
    - *Change anything! Use skillpower over willpower | Al Switzler | TEDxFremont*
___ 
