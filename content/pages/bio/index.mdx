...
+ Google Associate Cloud Engineer
    - [Certificate](https://www.credential.net/21f7a2f4-6c61-4c42-94a8-81e4ca9bc0db) issued on July 11, 2019
...
- Migrated entire RM Banking Platform from SQL Replication to Q Replication ( which includes 583 tables )
...
+ **Software Enginner - Db2 DBA** | May 5, 2008 - July 1, 2010
+ **Senior oftware Enginner - Db2 DBA** | July 1, 2010 - June 1, 2011
...
+ **[bobbydreamer.com](https://bobbydreamer.com)**
...
| Skill  | Used in                                  |
| ------ | ---------------------------------------- |
| mySQL | Home projects, since 2017 |
...
| Firebase | Using firebase realtime database from 2017 and [stash](https://stash.bobbydreamer.com) uses firebase as backend storage. |
| Python | Started using it since 2019 for [Udacity Data engineering](https://github.com/bobbydreamer/Udacity-Nano_Degree_Data_Engineering) | 
...
| GCP | Using it since 2017, major products i use are Firebase, Compute Engine, Cloud Source Repositories, Cloud Functions(NodeJS), Cloud Storage, Container Registry & GKE |
