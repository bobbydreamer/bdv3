...
* **Sublime** : When VS Code gets slow or when it takes too much memory, i switch to Sublime. This is one of the lowest memory consuming editor. All SQLs & CLI works, i use this.
