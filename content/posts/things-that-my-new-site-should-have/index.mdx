...
I decide to make new version of my site as, now i know,
...
**Collector mode ON** : I start saving links, taking screenshots, inspecting pages checking the CSS, noting down the font names, color codes and start watching all the Youtube recommended videos, all of this sort of gives you a feeling, *"Its calling me"*. 

This goes on for a year(2019). 

Below are the things i have collected to have on my site, overtime.  
