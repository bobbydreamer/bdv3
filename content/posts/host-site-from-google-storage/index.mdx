...
*This content is from 2018, migrated from my old site and below site has been migrated as well to [v2.bobbydreamer.com](http://www.v2.bobbydreamer.com)*     

Hosting a site from Google Cloud Storage, there is nothing more basic than this. 

Why ? 

You are about to host a .html file with images and hand-written CSS without any bootstrap. 
...
1. Go to Google Cloud Console
    ![Google Cloud Console](./image001.png)

1. Under Storage, hover on Storage and select "Browser"
    ![Google Cloud Console](./image002.png)
...
1. Create a bucket
    ...
    ![Google Cloud Console](./image003.png)

1. Click the bucket name once its created    
    ![Google Cloud Console](./image004.png)

1. Now you can “Upload Files” (OR) Drag&Drop them.
    ![Google Cloud Console](./image006.png)
...
1. Check and set Share publicly    
    ...
    ![Google Cloud Console](./image007.jpg)
...
![Google Cloud Console](./image013.png)
...
1. Type in the below information, type @ symbol at the subdomain and your site address in “destination URL” and then Click “Add”    
    ...
    ![Google Cloud Console](./image014.png)
...
1. It should look like and in a minute this should get updated and now you should be able to get to www.bobbydreamer.com just by typing bobbydreamer.com as well.
    ...
    ![Google Cloud Console](./image015.png)

In case, if the bucket is deleted, you will get below message

![Google Cloud Console](./image016.png)
