...
1. Go to [your homepage in Spotify](https://open.spotify.com/), click *Your Library* and then your playlist and then click on the 3 dots(...) and from submenu, copy the playlist link    
  ![Spotify - Copy playlist link](./spotify1.PNG)
...
All this in Spotify comes under **Play Button**, thats what its called. Here is the [link](https://developer.spotify.com/documentation/widgets/generate/play-button/)

Preview the [Spotify Player](../music) here
