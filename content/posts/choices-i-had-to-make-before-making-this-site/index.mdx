---
title: Choices i had to make before making this site
date: 2020-03-19
...
tags:
  ...
  - designs
banner: ./snails.jpg
slug: "/choices-i-had-to-make-before-making-this-site"
---

I decide to make V3 of my site as, now i know, whats SSR & How to host a site properly and learnt below things, 

1. NodeJS
1. Firebase database & hosting 
1. Cloud Functions
1. Google App Engine 
1. Github / Cloud Repository 

As usual, i start saving links, taking screenshots, inspecting the element in chrome, noting down the font names, color codes and watching and saving youtube videos, sometimes i download them, sometimes just save it in playlist, thinking, when i start the website making thing, i will rewatch the videos. 

This goes on for a year. 

Below are the things i have collected to have it on my site, overtime.  
...
![css-doodle.com](./BG1.PNG)  
![css-doodle.com](./BG2.PNG)  

Some doodle links

| Title                                    | Image |
| ---------------------------------------- | ---: |
| [Honeycomb](https://codepen.io/yuanchuan/pen/qBBMMGa) | ![Honeycomb](./Dood1.PNG) |
| [Flipping Arrows](https://codepen.io/saconway/pen/MWgxYYL) | ![Flipping Arrows](./Dood2.PNG) |
| [Dance](https://codepen.io/yuanchuan/pen/PMpEQo) | ![Dance](./Dood3.PNG) |
| [Waves](https://codepen.io/oliverturner/pen/Lojyvp) | ![Waves](./Dood4.PNG) |
| [DNA](https://codepen.io/yuanchuan/pen/pBrMNQ) | ![DNA](./Dood5.PNG) |
| [Shapes](https://codepen.io/yuanchuan/pen/oOgjYY) | ![Shapes](./Dood6.PNG) |
| [Doodle 1](https://codepen.io/rauldronca/pen/zMRvGM) | ![Doodle](./Dood7.PNG) |
| [TimeTravel](https://codepen.io/yuanchuan/pen/MqRyWJ) | ![TimeTravel](./Dood8.PNG) |
| [Ripple](https://codepen.io/yuanchuan/pen/NLRxvN) | ![Ripple](./Dood9.PNG) |
| [BorderStyles](https://codepen.io/yuanchuan/details/yqeoEb) | ![BorderStyles](./Dood10.PNG) |
| [Gradients](https://codepen.io/yuanchuan/pen/NzNMxy) | ![Gradients](./Dood11.PNG) |
...
![Website template with Sidebar](./SIDEBAR1.PNG)  
...
| Title                                    | Image |
| ---------------------------------------- | ---: |
| [ToC Bootstrap](https://afeld.github.io/bootstrap-toc/) | ![Table of Contents 1](./ToC1.PNG) |
| Scrollspy | - |
| [Sticky ToC](https://css-tricks.com/sticky-table-of-contents-with-scrolling-active-states/) | ![Table of Contents 3](./ToC3.PNG) |
...
![Blog Posts Orientiation](./Posts1.PNG)
...
* [mois-es - Horizontal Scrolling Pink & Red theme](https://mois-es.com/fr/faits)
  ```
  background:#ff4653; card=#9a223d; text=#f7dadf
  ```
![mois-es](./Colors4a.PNG)
![mois-es](./Colors4b.PNG)
...
* [amsterdamferryfestival](https://www.amsterdamferryfestival.nl/over/?lang=en)
  ...
  ```
![amsterdamferryfestival a](./Colors5a.PNG)
![amsterdamferryfestival b](./Colors5b.PNG)
![amsterdamferryfestival c](./Colors5c.PNG)
![amsterdamferryfestival d](./Colors5d.PNG)
![amsterdamferryfestival e](./Colors5e.PNG)
...
* [violetta - Violet Yellow theme](https://www.violetta.ch/)
  ...
  ```
![violetta a](./Colors6a.PNG)
![violetta b](./Colors6b.PNG)
...
![primer.style a](./Colors8a.PNG)
![primer.style b](./Colors8b.PNG)
...
![gummisig](./DesignerWeb1.PNG)

##### Making your own blog site

  1. Storage 
    + https://frankindev.com/2017/05/21/build-a-personal-markdown-notebook-with-firebase-storage/
...
##### Sorting it out 
After reviewing all the above again and again and looking at what i want and what i want to have and splitting out whats essential and whats not. A new thought came into my head after looking at all technical blogger sites. Their sites are very simple because they focus on content. So i started to think, do i have content for my beautiful site, "No", at the moment. So whats the point, you do all the hard as before, insense, in 2007 i made my first site and hosted in bravehost.com it was fully flash site. It was amazing, it had little content. Then in 2018, V2 of my site and it had only couple of content and i did not touch it afterwards. Now again it sort of looks like i am going the same thing. Well *"3 is a trend"*, so i decided to stop the designing part here. (PERIOD)

> Designer in me screamed, you cant take me out of you. You will still take screenshots, note down websites names, save the css, font names, those awesome colors, hexcodes, black spots in white background, how about little squares, diamonds, circles.....

##### New Plan 

1. Look for a static site generator 
1. Pick one 
...
1. Deploy via Firebase Hosting
1. Look into CI/CD
1. Post contents every week. 

In the end, i picked gatsby and theme [Gatsby Starter: Minimal Blog](https://github.com/LekoArts/gatsby-starter-minimal-blog)
